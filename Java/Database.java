...
public class Database {
	...
	/**
	 * @author tal20
	 * This enum maps from integers to their entries on the counter table
	 * 
	 */
	public enum Counter {
	...
	/**
	 * @author tal20
	 * This enum maps from full table names and local names.
	 */
	public enum Table {
...
//			}
	 ...
	 * clean the connection when finished.
	 */
	@Override
