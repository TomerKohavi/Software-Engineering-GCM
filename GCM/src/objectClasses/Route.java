...
public class Route implements ClassMustProperties, Serializable
{
	...
	public Route(Route other) throws SQLException
	{
		...
		for (RouteStop ars : other.getCopyRouteStops())
		{
			RouteStop newRs = RouteStop._createRouteStop(Database.generateIdRouteStop(), this.id,ars.getPlaceId() , ars.getNumStop(), ars.getRecommendedTime());
