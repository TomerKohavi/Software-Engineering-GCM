...
public class CitySearchTestTable {
            ...
            public static void initDatabaseConnection() {
            	...
            	//create cities
        		c1=new City("Haifa", "The third largest city in Israel. As of 2016, the city is a major seaport located on Israel's Mediterranean coastline in the Bay of Haifa covering 63.7 square kilometres.");
        		...
        		c1.saveToDatabase();
        		c2=new City("Tel Aviv", "The city is the second most populous city in Israel — after Jerusalem—and the most populous city in the conurbation of Gush Dan, Israel's largest metropolitan area.");
        		...
        		c2.saveToDatabase();
        		c3=new City("New York", "The City of New York, usually called either New York City (NYC) or simply New York (NY), is the most popular city in the United States.");
        		...
        		c3.saveToDatabase();
        		c4=new City("Jerusalem", "Jerusalem, of course, is not only the capital of Israel, but also one of the world’s most famous cities.");
