		    ...
		    public static Iterable<Object[]> data() {
		        return Arrays.asList(new Object[][] { 
		        		//cityName, cityDescription, placeName, placeDescription, useUnpublished,		expectedC1, expectedC2, expectedC3, expectedC4
		                 { "Haifa",null , null ,null , true ,											true , false, false, false },
		                 { null ,"the second most populous city in Israel" , null ,null , true ,		false , true, false, false },
		                 { null ,null , null ,"One of the biggest" , true ,								false , false, true, true },
		                 { null ,null , null ,"One of the biggest" , true ,							false , false, true, true },
		                 { "Tel Aviv" ,null , "Dizengoff Circle" ,null , true ,						false , true, false, false },
		                 { null ,null , "Brooklyn Bridge" ,null , true ,								false , false, true, false },
		                 { null ,"The City" , null ,"Israel" , true ,									true , true, false, false },
		                 { null ,null , null ,"area" , true ,											false , true, true, false },
		                 { null ,null , null ,"area Israel" , true ,									false , true, false, false },
		                 { "Jerusalem" ,null , null ,"wall" , true ,									false , false, false, true },
		                 { null ,"popular" , null ,"river" , true ,									false , false, true, false },
