...
public class InitDatebase {
	...
	private static void rome() {
		...
		PlaceOfInterest p0 = new PlaceOfInterest(c1.getId(), "Vatican", PlaceOfInterest.PlaceType.HISTORICAL,
				"Vatican City, "
				+ "officially Vatican City State "
				...
				true);
		p0.saveToDatabase();
		PlaceOfInterest p1 = new PlaceOfInterest(c1.getId(), "Colosseum", PlaceOfInterest.PlaceType.HISTORICAL,
